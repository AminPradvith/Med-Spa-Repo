   ...
   saveImage() {
       const finalCanvas = document.createElement('canvas');
        ...
        saveImageToSalesforce({ base64Data: dataUrl, recordId: this.recordId })
            ...
            console.log(result);
            if (result) {
                this.contentDocumentId = result; // Set the contentDocumentId attribute
                this.dispatchEvent(new CustomEvent('contentdocumentidchange', { detail: this.contentDocumentId }));
